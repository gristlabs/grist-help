...
We’re very excited to share some news that will help push Grist forward into the “sovereignty moment” that we’re experiencing worldwide. We think Grist is an excellent piece of software, but its also uniquely placed to provide real data ownership to the increasing number of organizations who are looking for it. We’ve made some leadership changes to make the most of this opportunity and reach these users:
...
* Show a nicer message when Airtable OAuth integration isn't configured.
