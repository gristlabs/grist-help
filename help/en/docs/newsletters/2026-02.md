...
We’re very excited to announce the you can now [Import from Airtable](https://support.getgrist.com/imports/#import-from-airtable){:target="\_blank"}! This new feature preserves the full contents of your base (including attachments) and the relationships between them.
...
* [v1.7.11](https://github.com/gristlabs/grist-core/releases/tag/v1.7.11){:target="\_blank"} for `grist-core`.
* [v0.3.10](https://github.com/gristlabs/grist-desktop/releases){:target="\_blank"} for `grist-desktop`.
...
* fcuignet has shared an [OpenStreetMap widget](https://github.com/fcuignet/GristOSM){:target="\_blank"} (on the right in the screenshot below) made with the custom widget builder. It just works!
...
[![How to set up Grist automations with n8n webinar](../images/newsletters/2026-02/webinar.png)](https://www.getgrist.com/webinars/how-to-set-up-grist-automations-with-n8n/?utm_source=support-newsletter&utm_medium=internal&utm_campaign=build-webinar&utm_term=march-2026)

**Thursday, March 19th at 11:00am US Eastern Time.**

[SIGN-UP FOR MARCH'S WEBINAR](https://www.getgrist.com/webinars/how-to-set-up-grist-automations-with-n8n/?utm_source=support-newsletter&utm_medium=internal&utm_campaign=build-webinar&utm_term=march-2026){:target="\_blank"}
{: .grist-button}
...
[WATCH FEBRUARY'S RECORDING](https://www.getgrist.com/webinars/migrate-airtable-to-grist-webinar/){:target="\_blank"}
{: .grist-button}
