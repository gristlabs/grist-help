...
[Join the discussion at HackerNews](https://news.ycombinator.com).
...
those with restrictive compliance requirements. Meanwhile, the service you know and love
...
- <a name="unique_ident"></a>
  **Cook up a Unique Identifier.** Let's say you'd like to refer to records in a table, but don't
  ...
  of a Reference column, you'll need a unique identifier.
    [Read more](#unique_ident){: .read-more}
...
showing PDF files, and various media attachments. Simply double-click a cell with attachments to
preview its content:
...
[Read more](#show_diffs){: .read-more}
...
changes](https://support.getgrist.com/copying-docs/#trying-out-changes), which should be familiar
