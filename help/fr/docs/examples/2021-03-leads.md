...
[Partagez le document](../sharing.md) avec quelqu'un d'autre en tant qu'éditeur et assurez-vous qu'ils [voient ce que vous attendez](../access-rules.md#voir-en-tant-quautre-utilisateur).
...
[table de propriété d'utilisateur](../access-rules.md#tables-dattributs-dutilisateur) :
