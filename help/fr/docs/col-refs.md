...
![explication des colonnes de référence - afficher la colonne](images/columns/columns-reference-explanation-show-column.png) {: .screenshot-half }
...
![Table de référence des villes](images/filter-reference-columns/cities-tables.png) <nl>{: .screenshot-half }</nl>
