...
Les permissions avancées de Grist vous donnent un grand pouvoir. Avec ce pouvoir vient une grande responsabilité. Prenez le temps de [lire notre documentation](../access-rules.md), [explorer les exemples](../access-rules.md#exemples-de-regles-dacces), et [tester les règles que vous créez](../access-rules.md#voir-en-tant-quautre-utilisateur). N'hésitez pas à nous consulter également à <support@getgrist.com>. Nous serons ravis de vous aider.
