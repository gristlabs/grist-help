...
Lors de l'importation de données supplémentaires dans une table existante dans Grist, vous pouvez maintenant mapper les colonnes de votre fichier aux colonnes de la table Grist. [En savoir plus.](../imports.md#importer-plus-de-donnees)
...
Il existe maintenant plus d'options de tri disponibles, y compris le tri naturel. En savoir plus sur [les options de tri supplémentaires.](../search-sort-filter.md#options-de-tri-avancees)
