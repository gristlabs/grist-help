...
Notez que cela permet à *n'importe qui* avec le lien de modifier absolument tout dans votre document, y compris de supprimer toutes les données. Les instantanés dans l'[Historique du Document](../automatic-backups.md#examiner-les-sauvegardes) devraient aider en cas de problème.
