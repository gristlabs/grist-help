...
- **Lien vers une cellule spécifique.** Sélectionnez une cellule et appuyez sur
  ...
  même cellule sélectionnée. [Plus d'infos ici](../enter-data.md#lien-vers-les-cellules).

[^copy-as-template]: Après la mise à jour de juillet 2020, sélectionnez "Dupliquer le Document", et cochez la case "Comme Modèle" dans la boîte de dialogue qui s'ouvre. Voir [Copier des Documents](../copying-docs.md#dupliquer-des-documents).
...
- Super-utilisateur ? Si vous avez envie de bidouiller, il existe désormais un moyen expérimental
  ...
  [Widget de page personnalisé](../widget-custom.md#widgets-personnalises-prefabriques) pour plus d'infos.
