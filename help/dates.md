...
objects](https://docs.python.org/3.11/library/datetime.html). That allows
...
[strptime() and strftime()](https://docs.python.org/3.11/library/datetime.html#strftime-strptime-behavior).
...
3. The third line uses Python's [strptime
   function](https://docs.python.org/3.11/library/datetime.html#datetime.datetime.strptime) to parse
   ...
   at the [format
   options](https://docs.python.org/3.11/library/datetime.html#strftime-strptime-behavior) to see if
...
[datetime.timedelta](https://docs.python.org/3.11/library/datetime.html#datetime.timedelta) object
...
Alternatively, we can use the [strftime](https://docs.python.org/3.11/library/datetime.html#strftime-strptime-behavior) function:
